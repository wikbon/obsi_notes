...
def main():
    ...
    print("For mathematical problems, add: 'Please reason step by step, and put your final answer within \\boxed{}'")
    print("\n")
    ...
    try:
        while True:
            ...
            response = handler.create_chat_completion(temperature=0.6)  # Using recommended temperature
