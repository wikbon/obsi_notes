...
def process_vault(
    vault_path: str, debug: bool = False, interactive: bool = False, export_json: bool = False
) -> None:
...
def main():
    ...
    parser.add_argument(
        "-f", "--file", action="store_true", help="Process single file instead of vault"
    )
    parser.add_argument(
        "-i", "--interactive", action="store_true", help="Interactively select a note to process"
    )
